...
//  Youra
//
//  Created by Stephen Giovanni Saputra on 04/04/22.
//
...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        self.window?.overrideUserInterfaceStyle = colorUserDefaults.colorshared.theme.getUserInterfaceStyle()
...
//		UserDefaults.standard.synchronize()
        ...
        let identifier  = (username == nil) ? "firstNavController" : "secondNavController"
        let storyboard =  (username == nil) ? "firstSetup" : "secondSetup"
